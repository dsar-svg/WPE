...
export function PublicMenuPage() {
  ...
  return (
    <main id="main-content" className="min-h-screen bg-dark font-body selection:bg-primary-vibrant text-white flex">
      <SEO
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 min-h-[60vh] bg-gradient-to-br from-primary-vibrant/[0.05] via-dark to-secondary-vibrant/[0.03]">
